...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!e.jQuery) {
        ...
        i.isWindow = function (e) {
            ...
            var o = 0, a = e.length, r = t(e);
            if (n) {
                if (r) for (; a > o && !1 !== i.apply(e[o], n); o++) ; else for (o in e) if (!1 === i.apply(e[o], n)) break
            } else if (r) for (; a > o && !1 !== i.call(e[o], o, e[o]); o++) ; else for (o in e) if (!1 === i.call(e[o], o, e[o])) break;
            return e
            ...
            var o = e[i.expando], a = o && n[o];
            a && i.each(t, function (e, t) {
                delete a[t]
            })
        }, i.extend = function () {
            var e, t, n, o, a, r, s = arguments[0] || {}, l = 1, c = arguments.length, u = !1;
            for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++) if (null != (a = arguments[l])) for (o in a) e = s[o], s !== (n = a[o]) && (u && n && (i.isPlainObject(n) || (t = i.isArray(n))) ? (t ? (t = !1, r = e && i.isArray(e) ? e : []) : r = e && i.isPlainObject(e) ? e : {}, s[o] = i.extend(u, r, n)) : void 0 !== n && (s[o] = n));
            return s
            ...
            init: function (e) {
                ...
                var t = this[0], e = e.apply(t), n = this.offset(),
    ...
    return function (e, t, i, n) {
        ...
        function l(e) {
            if (e) {
                var t = (new Date).getTime(), i = g.State.calls.length;
                ...
                for (var o = 0; i > o; o++) if (g.State.calls[o]) {
                    ...
                    for (var m = Math.min((t - p) / d.duration, 1), b = 0, w = s.length; w > b; b++) {
                        ...
                        if (a(C)) {
                            ...
                            for (var T in d.visibility !== n && "hidden" !== d.visibility && y.setPropertyValue(C, "visibility", d.visibility), x) if ("element" !== T) {
                                var O, $ = x[T], M = h.isString($.easing) ? g.Easings[$.easing] : $.easing;
                                if (1 === m) O = $.endValue; else {
                                    var E = $.endValue - $.startValue;
                                    if (O = $.startValue + E * M(m, d, E), !f && O === $.currentValue) continue
                                }
                                if ($.currentValue = O, "tween" === T) v = O; else {
                                    if (y.Hooks.registered[T]) {
                                        var P = y.Hooks.getRoot(T), I = a(C).rootPropertyValueCache[P];
            ...
            for (var i = g.State.calls[e][0], o = g.State.calls[e][1], r = g.State.calls[e][2], s = g.State.calls[e][4], l = !1, c = 0, d = i.length; d > c; c++) {
                ...
                if (t || r.loop || ("none" === r.display && y.setPropertyValue(p, "display", r.display), "hidden" === r.visibility && y.setPropertyValue(p, "visibility", r.visibility)), !0 !== r.loop && (u.queue(p)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(p)[1])) && a(p)) {
                    ...
                    u.each(y.Lists.transforms3D, function (e, t) {
                        var i = /^scale/.test(t) ? 1 : 0, o = a(p).transformCache[t];
                ...
                }), g(p, "reverse", {loop: !0, delay: r.delay})), !1 !== r.queue && u.dequeue(p, r.queue)
            }
            g.State.calls[e] = !1;
            for (var f = 0, v = g.State.calls.length; v > f; f++) if (!1 !== g.State.calls[f]) {
                l = !0;
                break
            }
        ...
        if (!(7 >= d)) {
            ...
            var b = function () {
                ...
                function i(i, n) {
                    var o = {dx: i.v, dv: e(i)}, a = t(i, .5 * n, o), r = t(i, .5 * n, a), s = t(i, n, r),
            ...
            var y = g.CSS = {
                ...
                Hooks: {
                    templates: {
                        ...
                        for (i in y.Hooks.templates) for (var e in o = (n = y.Hooks.templates[i])[0].split(" ")) {
                            var r = i + o[e], s = e;
                ...
                getPropertyValue: function (e, i, o, r) {
                    ...
                    if (!/^[\d-]/.test(l)) if (a(e) && a(e).isSVG && y.Names.SVGAttribute(i)) if (/^(height|width)$/i.test(i)) try {
                        l = e.getBBox()[i]
                    } catch (e) {
                        l = 0
                    } else l = e.getAttribute(i); else l = s(e, y.Names.prefixCheck(i)[0]);
                    return y.Values.isCSSNullValue(l) && (l = 0), g.debug >= 2 && console.log("Get " + i + ": " + l), l
                },
                setPropertyValue: function (e, i, n, o, r) {
                    var s = i;
                    if ("scroll" === i) r.container ? r.container["scroll" + r.direction] = n : "Left" === r.direction ? t.scrollTo(n, r.alternateValue) : t.scrollTo(r.alternateValue, n); else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", e)) y.Normalizations.registered[i]("inject", e, n), s = "transform", n = a(e).transformCache[i]; else {
                        if (y.Hooks.registered[i]) {
            ...
            var w = function () {
                ...
                function r() {
                    function e(e) {
                        ...
                        if ("scroll" === O) {
                            var w, x, T, M = /^x$/i.test(c.axis) ? "Left" : "Top", E = parseFloat(c.offset) || 0;
                            ...
                            for (var L in a(r).tweensContainer && !0 === a(r).isAnimating && (P = a(r).tweensContainer), u.each(b, function (e, t) {
                                ...
                                var H = p(b[L]), R = H[0], W = H[1], F = H[2];
                                L = y.Names.camelCase(L);
                                var V = y.Hooks.getRoot(L), N = !1;
                                if (a(r).isSVG || "tween" === V || !1 !== y.Names.prefixCheck(V)[1] || y.Normalizations.registered[V] !== n) {
                                    ...
                                    if (F = (Y = f(L, F))[0], X = Y[1], R = (Y = f(L, R))[0].replace(/^([+-\/*])=/, function (e, t) {
                                        return B = t, ""
                                    }), j = Y[1], F = parseFloat(F) || 0, R = parseFloat(R) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(L) ? (R /= 100, j = "em") : /^scale/.test(L) ? (R /= 100, j = "") : /(Red|Green|Blue)$/i.test(L) && (R = R / 100 * 255, j = "")), /[\/*]/.test(B)) j = X; else if (X !== j && 0 !== F) if (0 === R) j = X; else {
                                        o = o || v();
                    ...
                    var o, r = this, c = u.extend({}, g.defaults, k), d = {};
                ...
                if (h.isWrapped(this) ? (d = !1, f = 0, m = this, p = this) : (d = !0, f = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
                        ...
                        default:
                            if (!u.isPlainObject(b) || h.isEmptyObject(b)) {
                                if (h.isString(b) && g.Redirects[b]) {
                                    var E = (L = u.extend({}, k)).duration, P = L.delay || 0;
                    ...
                    if (u.each(m, function (e, t) {
                        h.isNode(t) && r.call(t)
                    }), (L = u.extend({}, g.defaults, k)).loop = parseInt(L.loop), A = 2 * L.loop - 1, L.loop) for (var H = 0; A > H; H++) {
            ...
            return g.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
                ...
                g.Redirects["slide" + t] = function (e, i, o, a, r, s) {
                    var l = u.extend({}, i), c = l.begin, d = l.complete,
                        p = {height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: ""}, h = {};
                ...
                g.Redirects["fade" + t] = function (e, i, o, a, r, s) {
                    var l = u.extend({}, i), c = {opacity: "In" === t ? 1 : 0}, d = l.complete;
    ...
    WOW = function () {
        return {
            init: function () {
                ...
                function n() {
                    ...
                    e(".wow").each(function () {
                        if ("visible" != e(this).css("visibility") && (i + n - 100 > o(this) && n < o(this) || i + n - 100 > o(this) + e(this).height() && n < o(this) + e(this).height() || i + n == e(document).height() && o(this) + 100 > e(document).height())) {
                            var a = e(this).index(".wow"), r = e(this).attr("data-wow-delay");
                            if (r) {
                ...
                function o(e) {
                    var t = e.getBoundingClientRect(), i = document.body, n = document.documentElement,
                ...
                e(".wow").each(function () {
                    ...
                    i ? (t = window.innerHeight, a = window.scrollY, e(".wow.animated").each(function () {
                        if (t + a - 100 > o(this) && a > o(this) + 100 || t + a - 100 < o(this) && a < o(this) + 100 || o(this) + e(this).height > e(document).height() - 100) e(this).removeClass("animated"), e(this).css({"animation-name": "none"}), e(this).css({visibility: "hidden"}); else {
                    ...
                    var i = e(this).index(".wow"), n = e(this).attr("data-wow-delay");
    ...
    "use strict";
    var e = e || {}, t = document.querySelectorAll.bind(document), i = Object.prototype.toString,
    ...
    function r(e) {
        var t, i, n = {top: 0, left: 0}, o = e && e.ownerDocument;
        return t = o.documentElement, void 0 !== e.getBoundingClientRect && (n = e.getBoundingClientRect()), i = function (e) {
            ...
            var t
        }(o), {top: n.top + i.pageYOffset - t.clientTop, left: n.left + i.pageXOffset - t.clientLeft}
    }
    ...
    return e.init = function (e) {
        ...
        var i = (e = a(e)).length;
        if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, i) for (var n, o, s, c = {}, u = 0, d = {
            type: "mousedown",
            button: 1
        }, p = function (e, t) {
            return function () {
...
!function (e) {
    var t, i,
        n = "".concat(["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (e) {
            return "input[type=".concat(e, "]")
        }).join(", "), ", textarea"), o = function (e) {
            var t = e.siblings("label, i"), i = e.val().length, n = e.attr("placeholder");
            t["".concat(i || n ? "add" : "remove", "Class")]("active")
        }, a = function (e) {
            if (e.hasClass("validate")) {
                var t = e.val(), i = !t.length, n = !e[0].validity.badInput;
                if (i && n) e.removeClass("valid").removeClass("invalid"); else {
                    var o = e.is(":valid"), a = Number(e.attr("length")) || 0;
            ...
            var t = e(_this);
            if (t.val().length) {
                var i = e(".hiddendiv"), n = t.css("font-family"), o = t.css("font-size");
    ...
    e(n).each(function (t, i) {
        var n = e(i), a = n.siblings("label, i");
        ...
        var i = e(t.target), n = !i.val(), o = !t.target.validity.badInput, r = void 0 === i.attr("placeholder");
        ...
        i.is("form") && (i.find(n).removeClass("valid").removeClass("invalid").each(function (t, i) {
            var n = e(i), o = !n.val(), a = !n.attr("placeholder");
            o && a && n.siblings("label, i").removeClass("active")
        }), i.find("select.initialized").each(function (t, i) {
            var n = e(i), o = n.siblings("input.select-dropdown"), a = n.children("[selected]").val();
            n.val(a), o.val(a)
        }))
    ...
    e(document).on("click.card", ".card", function (t) {
        if (e(this).find(".card-reveal").length) {
            var i = e(t.target), n = i.is(".card-reveal .card-title"), o = i.is(".card-reveal .card-title i"),
                a = i.is(".card .activator"), r = i.is(".card .activator i");
            n || o ? e(this).find(".card-reveal").velocity({translateY: 0}, {
                duration: 225,
                queue: !1,
            ...
            }) : (a || r) && e(this).find(".card-reveal").css({display: "block"}).velocity("stop", !1).velocity({translateY: "-100%"}, {
                duration: 300,
                queue: !1,
                easing: "easeInOutQuad"
            })
        ...
        var t = e(".front").outerHeight(), i = e(".back").outerHeight();
...
$(".smooth-scroll").on("click", "a", function () {
    ...
    e.fn.scrollTo = function (t) {
        ...
        function n(t, n) {
            var o = window.innerHeight, a = t.innerHeight(), r = t.offset().left,
                s = t.offset().top - e(window).scrollTop(), l = i.alignment, c = 0, u = 0, d = 0;
            !0 === i.belowOrigin && (d = a);
            var p = 0, h = t.parent();
            if (!h.is("body") && h[0].scrollHeight > h[0].clientHeight && (p = h[0].scrollTop), r + n.innerWidth() > e(window).width() ? l = "right" : r - n.innerWidth() + t.innerWidth() < 0 && (l = "left"), s + n.innerHeight() > o) if (s + a - n.innerHeight() < 0) {
                var f = o - s - d;
                n.css("max-height", f)
            } else d || (d += a), d -= n.innerHeight();
            if ("left" === l) c = i.gutter, u = t.position().left + c; else if ("right" === l) {
        ...
        return this.each(function () {
            var t = e(this), o = !1, a = e("#".concat(t.attr("data-activates")));
        ...
        this.filter(function (t, n) {
            e(n).on("keyup", function () {
                for (var e = i.closest("div[id]").find("a, li"), t = 0; t < e.length; t++) e.eq(t).html().toUpperCase().indexOf(i.val().toUpperCase()) > -1 ? e.eq(t).css({display: ""}) : e.eq(t).css({display: "none"})
            })
        });
        var n = e.extend({
            color: "#000",
...
function dropdownEffectData(e) {
    var t = "fadeIn", i = "fadeOut", n = $(e), o = $(".dropdown-menu", e), a = n.parents("ul.nav");
...
dropdownSelectors.on({
    ...
    var t = 240, i = 1440, n = 300, o = 200, a = 50, r = 200, s = "easeOutQuad", l = "easeOutCubic", c = !0, u = !1,
        d = function () {
            function d(p, h) {
            ...
            return _createClass(d, [{
                ...
                key: "touchendEventHandler", value: function (e) {
                    if ("touchend" === e.type) {
                        ...
                        var i = this.calculateTouchVelocityX(), n = t.clientX, o = n - this.options.MENU_WIDTH,
                ...
                key: "panendEventHandler", value: function (e) {
                    if ("touch" === e.gesture.pointerType) {
                        var t = e.gesture.velocityX, i = e.gesture.center.x, n = i - this.options.MENU_WIDTH,
                ...
                key: "openOnClick", value: function () {
                    ...
                    this.$element.on("click", function (i) {
                        if (i.preventDefault(), !0 === t.menuOut) t.removeMenu(); else {
                            ...
                            var n = [];
                            n = "left" === t.options.edge ? [0, -1 * t.options.MENU_WIDTH] : [0, t.options.MENU_WIDTH], "matrix(1, 0, 0, 1, 0, 0)" !== t.$menu.css("transform") && t.$menu.velocity({translateX: n}, {
    ...
    e.fn.collapsible = function (t) {
        ...
        return t = e.extend(i, t), this.each(function () {
            var i = e(this), s = e(this).find("> li > .collapsible-header"), l = i.data("collapsible");
...
var MaterialSelectViewRenderer = function () {
    ...
    return _createClass(e, [{
        ...
        key: "setWrapperClasses", value: function () {
        ...
        key: "setMaterialSelectInitialValue", value: function () {
        ...
        key: "appendSelectLabel", value: function () {
        ...
        key: "appendCustomTemplateParts", value: function () {
            var e = this;
        ...
        key: "appendValidationFeedbackElements", value: function () {
        ...
        key: "setMaterialOptionsListMaxHeight", value: function () {
            var e = this.view.options.visibleOptions, t = 0;
            this.view.$materialOptionsList.show();
            var i = this.view.$materialOptionsList.find("li").not(".disabled"), n = i.first().height(), o = i.length;
        ...
        key: "addAccessibilityAttributes", value: function () {
            this.view.$materialSelect.attr({
                ...
                var e = $(this);
                e.attr({role: "option", "aria-selected": e.hasClass("active"), "aria-disabled": e.hasClass("disabled")})
            })
        }
    }, {
        ...
        key: "appendSearchInputOption", value: function () {
            var e = this.view.$nativeSelect.attr("searchable"), t = this.isDefaultMaterialInput ? "" : "md-form",
        ...
        key: "buildMaterialOptions", value: function () {
            ...
            this.view.$nativeSelectChildren.each(function (t, i) {
                var n = $(i);
                if (n.is("option")) e.buildSingleOption(n, e.isMultiple ? "multiple" : ""); else if (n.is("optgroup")) {
        ...
        key: "buildSingleOption", value: function (e, t) {
            var i = e.is(":disabled") ? "disabled" : "", n = e.is(":selected") ? "active" : "",
                o = "optgroup-option" === t ? "optgroup-option" : "", a = e.data("icon"),
...
var MaterialSelectView = function () {
    ...
    return _createClass(e, [{
        ...
        key: "selectPreselectedOptions", value: function (e) {
            var t = this;
        ...
        key: "bindMaterialSelectFocus", value: function () {
            var e = this;
            this.$materialSelect.on("focus", function (t) {
                ...
                if ($("ul.select-dropdown").not(e.$materialOptionsList.get(0)).is(":visible") && $("input.select-dropdown").trigger("close"), e.$mainLabel.addClass("active"), !e.$materialOptionsList.is(":visible")) {
                    ...
                    var n = i.val(), o = e.$materialOptionsList.find("li").filter(function () {
        ...
        key: "bindMaterialSelectClick", value: function () {
            var e = this;
        ...
        key: "bindMaterialSelectBlur", value: function () {
            var e = this;
        ...
        key: "bindMaterialSelectKeydown", value: function () {
            var e = this;
            this.$materialSelect.on("keydown", function (t) {
                var i = $(t.target), n = t.which === e.keyCodes.tab, o = t.which === e.keyCodes.esc,
                    a = t.which === e.keyCodes.enter, r = a && t.shiftKey, s = t.which === e.keyCodes.arrowUp,
                    l = t.which === e.keyCodes.arrowDown, c = e.$materialOptionsList.is(":visible");
                if (n) e._handleTabKey(i); else if (!l || c) {
        ...
        key: "bindMaterialSelectDropdownToggle", value: function () {
            var e = this;
        ...
        key: "bindToggleAllClick", value: function (e) {
            var t = this;
            this.$toggleAll.on("click", function (i) {
                var n = $(t.$toggleAll).find('input[type="checkbox"]').first(), o = Boolean($(n).prop("checked")),
                    a = !o;
        ...
        key: "bindMaterialOptionMousedown", value: function () {
            var e = this;
        ...
        key: "bindMaterialOptionClick", value: function (e) {
            var t = this;
        ...
        key: "bindSingleMaterialOptionClick", value: function () {
            var e = this;
        ...
        key: "bindSearchInputKeyup", value: function () {
            var e = this;
        ...
        key: "bindHtmlClick", value: function () {
            var e = this;
        ...
        key: "bindMobileDevicesMousedown", value: function () {
        ...
        key: "bindSaveBtnClick", value: function () {
            var e = this;
        ...
        key: "_updateToggleAllOption", value: function () {
            var e = this.$materialOptionsList.find("li").not(".select-toggle-all, .disabled, :hidden").find("[type=checkbox]"),
                t = e.filter(":checked"), i = this.$toggleAll.find("[type=checkbox]").is(":checked");
        ...
        key: "_handleArrowUpDownKey", value: function (e) {
            var t = this, i = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all"),
                n = i.first(), o = i.last(), a = this.$materialOptionsList.find("li.selected").length > 0, r = null,
                s = null;
        ...
        key: "_handleLetterKey", value: function (e) {
            ...
            if (this._removeKeyboardActiveClass(), this.isSearchable) {
                var i = e.which > 46 && e.which < 91, n = e.which > 93 && e.which < 106, o = 8 === e.which;
                (i || n) && this.$searchInput.find("input").val(e.key).focus(), o && this.$searchInput.find("input").val("").focus()
            } else {
                var a = "", r = String.fromCharCode(e.which).toLowerCase(),
        ...
        key: "_removeKeyboardActiveClass", value: function () {
        ...
        key: "_updateDropdownScrollTop", value: function () {
        ...
        key: "_copyOptions", value: function (e) {
            return $.extend({}, e)
        }
    }, {
        key: "_jQueryFallback", value: function () {
            for (var e = null, t = 0; t < arguments.length; t++) if ((e = t < 0 || arguments.length <= t ? void 0 : arguments[t]).length) return e;
            return e
        }
    }, {
        key: "isMultiple", get: function () {
...
jQuery(function (e) {
    var t, i = function () {
        ...
        return _createClass(t, [{
            ...
            key: "bindMutationObserverChange", value: function () {
            ...
            key: "_onMutationObserverChange", value: function (i) {
                i.forEach(function (i) {
                    ...
                    !0 !== n.data("stop-refresh") && ("childList" === i.type || "attributes" === i.type && e(i.target).is("option")) && (t.clearMutationObservers(), n.materialSelect({destroy: !0}), n.materialSelect())
                })
            }
        }, {
            key: "_toggleSelectedValue", value: function (e) {
                var t = this.selectedOptionsIndexes.indexOf(e), i = -1 !== t;
            ...
            key: "_setValueToMaterialSelect", value: function () {
                var e = this, t = "", i = this.selectedOptionsIndexes.length;
    ...
    var t = e(window), i = e(document), n = e(document.documentElement),
        o = null != document.documentElement.style.transition;

    function a(t, n, c, d) {
        if (!t) return a;
        var p = !1, h = {id: t.id || "P" + Math.abs(~~(Math.random() * new Date)), handlingOpen: !1},
            f = c ? e.extend(!0, {}, c.defaults, d) : d || {}, v = e.extend({}, a.klasses(), f.klass), m = e(t), g = 2,
            b = function () {
                return this.start()
            }, y = b.prototype = {
                constructor: b, $node: m, start: function () {
                    ...
                    return g++, h.open ? y : g < 4 && f.editable ? y : (setTimeout(function () {
                        ...
                        var n = i.keyCode, o = y.component.key[n], r = s(i, t);
                    ...
                    var o, a, r = e.isPlainObject(t), s = r ? t : {};
                    ...
                    var o, a, r = e.isPlainObject(t), s = r ? t : {};
                    if (t) for (o in r || (s[t] = i), s) a = s[o], n && (o = "_" + o), h.methods[o] = h.methods[o] || [], h.methods[o].push(a);
                    return y
                }, off: function () {
                    var e, t, i = arguments;
        ...
        function k() {
            y.$holder.on({
                keydown: C, "focus.toOpen": x, blur: function () {
                ...
                var t = e(this), i = t.data(), n = t.hasClass(v.navDisabled) || t.hasClass(v.disabled), o = u();
    ...
    function r() {
        ...
        var i = e('<div style="visibility:hidden;width:100px" />').appendTo("body"), o = i[0].offsetWidth;
    ...
    function l(t, i, n) {
        if (e.isPlainObject(i)) for (var o in i) c(t, o, i[o]); else c(t, i, n)
    }
    ...
    function o(e, t) {
        var i, n = this, o = e.$node[0], a = o.value, r = e.$node.data("value"), s = r || a,
            l = r ? t.formatSubmit : t.format, c = function () {
    ...
    o.prototype.set = function (e, t, i) {
        ...
        var o, a, r, s, l = t.isArray(i), c = t.isPlainObject(i), u = this.item.view;
        if (l || c) {
        ...
        return n.isInteger(t) ? t = this.now(e, t, {rel: t}) : t ? "string" == typeof t && (t = this.parse(e, t)) : t = "min" == e ? -1 / 0 : 1 / 0, t
        ...
        var a, r, s, l, c = this, u = i, d = o && o.interval ? o.interval : 1, p = -1 === c.item.enable, h = c.item.min,
            f = c.item.max, v = p && c.item.disable.filter(function (e) {
                if (t.isArray(e)) {
        ...
        return t && "string" == typeof t ? (i && i.format || ((i = i || {}).format = o.settings.format), o.formats.toArray(i.format).map(function (e) {
            var i = o.formats[e], r = i ? n.trigger(i, o, [t, a]) : e.replace(/^!/, "").length;
        ...
        return "flip" == i ? o.flipEnable() : !1 === i ? (o.flipEnable(1), a = []) : !0 === i ? (o.flipEnable(-1), a = []) : i.map(function (e) {
            for (var i, r = 0; r < a.length; r += 1) if (o.isDateExact(e, a[r])) {
                i = !0;
                break
            }
        ...
        return "flip" == i ? o.flipEnable() : !0 === i ? (o.flipEnable(1), a = []) : !1 === i ? (o.flipEnable(-1), a = []) : i.map(function (e) {
            ...
            if (i) for (l = 0; l < r; l += 1) if (o.isDateExact(a[l], e)) {
                a[l] = null;
                break
            }
            if (c) for (l = 0; l < r; l += 1) if (o.isDateOverlap(a[l], e)) {
                a[l] = null;
                break
            }
            i && a.push(i)
        ...
        var t, i, o = this, a = o.settings, r = o.item, s = r.now, l = r.select, c = r.highlight, u = r.view,
            d = r.disable, p = r.min, h = r.max,
            f = (t = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), i = a.weekdaysFull.slice(0), a.firstDay && (t.push(t.shift()), i.push(i.shift())), n.node("thead", n.node("tr", n.group({
                ...
                }), a.klass.selectMonth, (e ? "" : "disabled") + " " + n.ariaAttr({controls: o.$node[0].id + "_table"}) + ' title="' + a.labelMonthSelect + '"') : n.node("div", t[u.month], a.klass.month)
            }, g = function () {
                var t = u.year, i = !0 === a.selectYears ? 5 : ~~(a.selectYears / 2);
                if (i) {
                    var r = p.year, s = h.year, l = t - i, c = t + i;
                    ...
                    }), a.klass.selectYear, (e ? "" : "disabled") + " " + n.ariaAttr({controls: o.$node[0].id + "_table"}) + ' title="' + a.labelYearSelect + '"')
                }
            ...
            item: function (e) {
                ...
                return [n.group({
                    min: 7 * e - u.day + t + 1, max: function () {
                        ...
                        var t, i = l && l.pick == e.pick, r = c && c.pick == e.pick,
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var e = this.$root, t = this.get("highlight", "yyyy"), i = this.get("highlight", "dd"),
    ...
    var e, t, i, n = window.jQuery, o = n(window), a = n(document), r = "http://www.w3.org/2000/svg",
    ...
    var g = 0;
    var b = 135, y = 110, w = 80, k = 20, x = 2 * b, C = l ? 350 : 1,
    ...
    function T(e, t) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            h = r.find(".clockpicker-hours"), T = r.find(".clockpicker-minutes"),
            $ = r.find(".clockpicker-am-pm-block"), M = "INPUT" === e.prop("tagName"), E = M ? e : e.find("input"),
            P = (E.prop("type"), n("label[for=" + E.attr("id") + "]")), I = this;
        ...
        if (t.twelvehour) for (L = 0; L < 12; L += t.hourstep) D = R.clone(), _ = L / 6 * Math.PI, H = y, D.css("font-size", "140%"), D.css({
            left: b + Math.sin(_) * H - k,
            top: b - Math.cos(_) * H - k
        }), D.html(0 === L ? 12 : L), h.append(D), D.on(u, V); else for (L = 0; L < 24; L += t.hourstep) {
        ...
        for (L = 0; L < 60; L += F) for (L = 0; L < 60; L += 5) D = R.clone(), _ = L / 30 * Math.PI, D.css({
            left: b + Math.sin(_) * y - k,
            top: b - Math.cos(_) * y - k
        }), D.css("font-size", "140%"), D.html(m(L)), T.append(D), D.on(u, V);

        function V(e, i) {
            var n = l.offset(), o = /^touch/.test(e.type), r = n.left + b, c = n.top + b,
                u = (o ? e.originalEvent.touches[0] : e).pageX - r, h = (o ? e.originalEvent.touches[0] : e).pageY - c,
                f = Math.sqrt(u * u + h * h), v = !1;
            if (!i || !(f < y - k || f > y + k)) {
                e.preventDefault();
                ...
                s && l.append(I.canvas), I.setHand(u, h, !i, !0), a.off(d).on(d, function (e) {
                    ...
                    var n = /^touch/.test(e.type), o = (n ? e.originalEvent.changedTouches[0] : e).pageX - r,
        ...
        if (l.on(u, function (e) {
            ...
            var N = r.find(".clockpicker-canvas"), Y = f("svg");
    ...
    T.DEFAULTS = {
        ...
        var t = this.currentView, i = this[t], n = "hours" === t, o = i * (Math.PI / (n ? 6 : 30)),
            a = n && i > 0 && i < 13 ? w : y, r = Math.sin(o) * a, l = -Math.cos(o) * a, c = this;
        ...
        var a, r, l = Math.atan2(e, -t), c = "hours" === this.currentView, u = Math.sqrt(e * e + t * t),
            d = this.options, p = c && u < (y + w) / 2, f = p ? w : y;
        if (a = c ? d.hourstep / 6 * Math.PI : d.minutestep / 30 * Math.PI, d.twelvehour && (f = y), l < 0 && (l = 2 * Math.PI + l), l = (r = Math.round(l / a)) * a, c ? (r *= d.hourstep, d.twelvehour || !p != r > 0 || (r += 12), d.twelvehour && 0 === r && (r = 12), 24 === r && (r = 0)) : 60 === (r *= d.minutestep) && (r = 0), c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && h && this.options.vibrate && (this.vibrateTimer || (navigator[h](10), this.vibrateTimer = setTimeout(n.proxy(function () {
            ...
            var v = Math.sin(l) * f, g = -Math.cos(l) * f;
        ...
        var e = this.input.prop("value"), t = this.hours, i = ":" + m(this.minutes);
    ...
    return function (e, t, i, n) {
        ...
        o.detectFeatures(), o.features.oldIE && (o.bind = function (e, t, i, n) {
            ...
            }, s = 0; s < t.length; s++) if (o = t[s]) if ("object" == typeof i && i.handleEvent) {
                if (n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, p, h, f, v, m, g, b, y, w, k, x, C, S, T, O, $, M, E, P, I, A, L, D, _, H, R, W, F, V, N, Y,
            j, X, B, z, q, U, K, Z, Q, G, J, ee, te, ie, ne, oe, ae, re, se, le = {x: 0, y: 0}, ce = {x: 0, y: 0},
            ue = {x: 0, y: 0}, de = {}, pe = 0, he = {}, fe = {x: 0, y: 0}, ve = 0, me = !0, ge = [], be = {}, ye = !1,
            we = function (e, t) {
                ...
                if (!r.loop && t) {
                    var i = u + (fe.x * pe - e) / fe.x, n = Math.round(e - ct.x);
                ...
                shout: Se, listen: Ce, viewportSize: de, options: r, isMainScrollAnimating: function () {
                    return te
                    ...
                    if (!s && !l) {
                        ...
                        a.framework = o, a.template = e, a.bg = o.getChildByClass(e, "pswp__bg"), L = e.className, s = !0, R = o.detectFeatures(), I = R.raf, A = R.caf, M = R.transform, _ = R.oldIE, a.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = x = [{
                            ...
                            M = "left", o.addClass(e, "pswp--ie"), Pe = function (e, t) {
                                ...
                                if (ee) {
                                    var e = ee, t = a.currItem, i = t.fitRatio > 1 ? 1 : t.fitRatio, n = i * t.w,
                                        o = i * t.h;
                                    e.width = n + "px", e.height = o + "px", e.left = ue.x + "px", e.top = ue.y + "px"
                                }
                            }
                        }(), v = {resize: a.updateSize, scroll: je, keydown: Ne, click: Ye};
            ...
            }, Qe = {}, Ge = {}, Je = {}, et = {}, tt = {}, it = [], nt = {}, ot = [], at = {}, rt = 0, st = {x: 0, y: 0},
            lt = 0, ct = {x: 0, y: 0}, ut = {x: 0, y: 0}, dt = {x: 0, y: 0}, pt = function (e, t) {
                ...
                var i, n, o, s, l = ue[e] + t[e], c = t[e] > 0, u = ct.x + t.x, d = ct.x - nt.x;
                ...
                if (X) {
                    var n = St(e);
                    if (ie || q || Q) Z = n; else if (ct.x !== fe.x * pe) ie = "h"; else {
                ...
                var c = -1;
                if (0 === l && (X = !1, o.unbind(window, h, a), ht(), Q ? c = 0 : -1 !== lt && (c = Te() - lt)), lt = 1 === l ? Te() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Q && 2 > l && (Q = !1, 1 === l && (n = "zoomPointerUp"), Se("zoomGestureEnded")), Z = null, q || z || te || Y) if (Ue(), V || (V = Pt()), V.calculateSwipeSpeed("x"), Y) if (wt() < r.verticalDragRange) a.close(); else {
                    var u = ue.y, d = ae;
                ...
                var d, p = fe.x * pe, h = Math.abs(p - ct.x);
        ...
        var _t, Ht, Rt, Wt, Ft, Vt, Nt = function (t, i, n, s) {
            ...
            var d = n ? r.hideAnimationDuration : r.showAnimationDuration, p = function () {
            ...
            !function () {
                ...
                t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (m = l.w / t.w, ue.x = l.x, ue.y = l.y - D, a[s ? "template" : "bg"].style.opacity = .001, Me()), qe("initialZoom"), n && !i && o.removeClass(e, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    if (Se("initialZoom" + (n ? "Out" : "In")), n) {
                        var a = l.w / t.w, r = {x: ue.x, y: ue.y}, c = m, u = ae, h = function (t) {
            ...
            publicMethods: {
                lazyLoadItem: function (e) {
                    ...
                    o.extend(r, Xt, !0), a.items = Ht = i, Ft = a.getItemAt, Vt = r.getNumItemsFn, r.loop, Vt() < 3 && (r.loop = !1), Ce("beforeChange", function (e) {
                        var t, i = r.preload, n = null === e || e >= 0, o = Math.min(i[0], Vt()),
                            s = Math.min(i[1], Vt());
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ut(l), Bt(l, de), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Kt(l, n), zt(0, l, c, n)); else {
        ...
        var Qt, Gt, Jt = {}, ei = function (e, t, i) {
        ...
        we("Tap", {
            ...
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    if (e.stopPropagation(), Gt.x = 0, "deltaX" in e) 1 === e.deltaMode ? (Gt.x = 18 * e.deltaX, Gt.y = 18 * e.deltaY) : (Gt.x = e.deltaX, Gt.y = e.deltaY); else if ("wheelDelta" in e) e.wheelDeltaX && (Gt.x = -.16 * e.wheelDeltaX), e.wheelDeltaY ? Gt.y = -.16 * e.wheelDeltaY : Gt.y = -.16 * e.wheelDelta; else {
                    ...
                    var i = r.getDoubleTapZoom(!0, a.currItem), n = m === i;
                    a.mouseZoomedIn = !n, a.zoomTo(n ? a.currItem.initialZoomLevel : i, t, 333), o[(n ? "remove" : "add") + "Class"](e, "pswp--zoomed-in")
                }
            }
        });
        var ti, ii, ni, oi, ai, ri, si, li, ci, ui, di, pi, hi = {history: !0, galleryUID: 1}, fi = function () {
            ...
            if (r.galleryPIDs) {
                var a = t.pid;
                for (t.pid = 0, i = 0; i < Ht.length; i++) if (Ht[i].pid === a) {
                    t.pid = i;
                    break
                }
            ...
            if (ni && clearTimeout(ni), Be || X) ni = setTimeout(gi, 500); else {
    ...
    "use strict";
    return function (e, t) {
        var i, n, o, a, r, s, l, c, u, d, p, h, f, v, m, g, b, y, w = this, k = !1, x = !0, C = !0, S = {
            ...
            for (var i = 0; i < m.closeElClasses.length; i++) if (t.hasClass(e, "pswp__" + m.closeElClasses[i])) return !0
        }, D = 0, _ = function () {
            ...
            if (O()) {
                var r = m.barsSize;
                if (m.captionEl && "auto" === r.bottom) if (a || ((a = t.createEl("pswp__caption pswp__caption--fake")).appendChild(t.createEl("pswp__caption__center")), n.insertBefore(a, o), t.addClass(n, "pswp__ui--fit")), m.addCaptionHTMLFn(e, a, !0)) {
        ...
        w.init = function () {
            t.extend(e.options, S, !0), m = e.options, n = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, function () {
                var e;
...
var initPhotoSwipeFromDOM = function (e) {
    for (var t = function (e) {
        ...
        if (t) {
            for (var n, o = t.parentNode, a = t.parentNode.childNodes, r = a.length, s = 0, l = 0; l < r; l++) if (1 === a[l].nodeType) {
                if (a[l] === t) {
                    n = s;
                    break
                }
        ...
        if (a = function (e) {
            ...
            galleryUID: t.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (e) {
                var t = a[e].el.getElementsByTagName("img")[0],
                    i = window.pageYOffset || document.documentElement.scrollTop, n = t.getBoundingClientRect();
                return {x: n.left, y: n.top + i, w: n.width}
            }
        }, n) if (o.galleryPIDs) {
            for (var s = 0; s < a.length; s++) if (a[s].pid == e) {
                o.index = s;
                break
            }
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (e) {
    e.fn.sticky = function (t) {
        ...
        return this.each(function () {
            var t = e(this), a = t.outerHeight(), r = t.outerWidth(), s = i.topSpacing, l = i.zIndex,
                c = t.offset().top - s, u = e("<div></div>").width(r).height(a).addClass("sticky-placeholder"),
                d = i.stopper, p = e(window);

            function h() {
                var r = p.scrollTop(), h = d, f = t.parent().width();
    ...
    function r(e, t) {
        var i = e.element.classList, n = m.state.scrolling(t);
    ...
    function f(e, t) {
        ...
        var o = t[0], a = t[1], l = t[2], c = t[3], u = t[4], d = t[5], p = t[6], h = t[7], f = t[8], v = e.element,
    ...
    var k = function (e, t, i, n, o) {
        var a;
        if (void 0 === n && (n = !0), void 0 === o && (o = !1), "top" === t) a = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"]; else {
            if ("left" !== t) throw new Error("A proper axis should be provided");
            a = ["contentWidth", "containerWidth", "scrollLeft", "x", "left", "right"]
        }
        !function (e, t, i, n, o) {
            var a = i[0], r = i[1], s = i[2], u = i[3], d = i[4], p = i[5];
        ...
        "click-rail": function (e) {
            ...
            function i(e, i) {
                var n = Math.floor(u.scrollTop), o = u.scrollLeft, a = Math.abs(e), r = Math.abs(i);
                if (r > a) {
            ...
            if (x.supportsTouch || x.supportsIePointer) {
                var u = t.element, d = {}, p = 0, h = {}, f = null;
        ...
        this.scrollbarXBottom = parseInt(c.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = u(c.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = u(c.borderLeftWidth) + u(c.borderRightWidth), t(this.scrollbarXRail, {display: "block"}), this.railXMarginWidth = u(c.marginLeft) + u(c.marginRight), t(this.scrollbarXRail, {display: ""}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = i(m.element.rail("y")), n.appendChild(this.scrollbarYRail), this.scrollbarY = i(m.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", s), this.event.bind(this.scrollbarY, "blur", l), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
    ...
    return T.prototype.update = function () {
        this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, t(this.scrollbarXRail, {display: "block"}), t(this.scrollbarYRail, {display: "block"}), this.railXMarginWidth = u(e(this.scrollbarXRail).marginLeft) + u(e(this.scrollbarXRail).marginRight), this.railYMarginHeight = u(e(this.scrollbarYRail).marginTop) + u(e(this.scrollbarYRail).marginBottom), t(this.scrollbarXRail, {display: "none"}), t(this.scrollbarYRail, {display: "none"}), C(this), k(this, "top", 0, !1, !0), k(this, "left", 0, !1, !0), t(this.scrollbarXRail, {display: ""}), t(this.scrollbarYRail, {display: ""}))
    ...
    var t = {}, i = "", n = "", o = "#ced4da", a = "1px solid #4285f4", r = "1px solid #ced4da",
                ...
                key: "inputKeyupData", value: function () {
                    ...
                    this.$input.on("keyup", function (i) {
                        ...
                        if (t.$autocompleteWrap.empty(), n.length) {
                            for (var o in t.options.data) if (-1 !== t.options.data[o].toLowerCase().indexOf(n.toLowerCase())) {
                                var a = e("<li>".concat(t.options.data[o], "</li>"));
                                t.$autocompleteWrap.append(a)
                            }
                            var r = t.$autocompleteWrap, s = t.$autocompleteWrap.find("li"), l = s.eq(c).outerHeight(),
    ...
    var e = {
        ...
        var i = "", n = t.parentNode.querySelector(e.CUSTOMFILELABEL);
        return n && (i = n.innerHTML), i
    }, i = function (e) {
        if (e.childNodes.length > 0) for (var t = [].slice.call(e.childNodes), i = 0; i < t.length; i++) {
            var n = t[i];
            if (3 !== n.nodeType) return n
        }
        return e
    }, n = function (t) {
        var n = t.bsCustomFileInput.defaultText, o = t.parentNode.querySelector(e.CUSTOMFILELABEL);
        o && (i(o).innerHTML = n)
    }, o = !!window.File, a = function (e) {
