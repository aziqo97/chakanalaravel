                                ...
                                <div class="col-xl-4 col-md-5">
                                    <div class="orderStatus__left">
                                        <img src="https://chakana.uz/redesign-assets/dist/images/icons/order-status.svg"
                                             alt="order">
                                        <h1>Yangi kategoriya qoshish menyusi</h1>
                                        <p>Yangi kategoriya qoshish vaqtida agar kerakli kategoriya tanlanmasa yangi
                                            katalog yaratiladi.</br>
                                            Agar kategoriya tanlansa Podkatalog yaratiladi</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="orderStatus__right">
                                        <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div
                                                ...
                                                <label class="control-label" for="identifier-input">Kategoriya nomi
                                            ...
                                            <div
                                                class="js-form-message form-group custom__form-group field-identifier-input required">
                                                <label class="control-label" for="identifier-input">Kategoriya rasmi
                                                    <span class="text-danger">*</span></label>
                                                <input type="file" class="form-control custom__form-control" name="photo"
                                                       required>
                                                <div class="help-block"></div>
                                            </div>
